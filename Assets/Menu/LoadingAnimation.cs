...
public class LoadingAnimation : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        m_LoadingProgressBar = m_Root.Q<ProgressBar>("bar_Progress1");
    ...
    private void AnimateLoadingBar(float progress)
    {
        ...
        DOTween.To(() => m_LoadingProgressBar.worldBound.width, x => m_LoadingProgressBar.style.width = x, 100, 5f).SetEase(Ease.Linear);
    }
